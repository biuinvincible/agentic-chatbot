...
3. In your report, you should return inline citations for each source that the researcher found, using the format [1], [2], [3], etc.
4. You should include a "### References" section at the end of the report that lists all of the sources the researcher found with corresponding citations, cited against statements in the report.
5. Make sure to include ALL of the sources that the researcher gathered in the report, and how they were used to answer the question!
6. It's really important not to lose any sources. A later LLM will be used to merge this report with others, so having all of the sources is critical.
7. CRITICAL: When listing sources in the References section, ALWAYS include the full URL for each source. The format should be:
   [1] Source Title: URL
   [2] Source Title: URL
   Where "Source Title" is the title of the source and "URL" is the full URL.
</Guidelines>
...
<Citation Rules>
- Assign each unique URL a single citation number in your text using format [1], [2], [3], etc.
...
- Example format:
  [1] Source Title: URL
  [2] Source Title: URL
- Every citation number [1], [2], [3] used in the text must have a corresponding entry in the References section
- Include ALL sources that were referenced in your report
</Citation Rules>
...
3. References relevant sources using numbered citations in the format [1], [2], [3], etc.
4. Provides a balanced, thorough analysis. Be as comprehensive as possible, and include all information that is relevant to the overall research question. People are using you for deep research and will expect detailed, comprehensive answers.
5. Includes a "### References" section at the end with all referenced sources numbered sequentially (1, 2, 3, ...) and formatted as:
   [1] Source Title: URL
   [2] Source Title: URL
   [3] Source Title: URL
6. Each citation number in the text [1], [2], [3] must correspond to a source in the References section
7. Make sure to include ALL sources that were referenced in the report, and number them sequentially without gaps
...
- IMPORTANT: Number sources sequentially without gaps (1,2,3,4...) in the final list regardless of which sources you choose
- Each source should be a separate line item in a list, so that in markdown it is rendered as a list.
- CRITICAL: Use REAL URLs from the research findings, NOT placeholder URLs. The URLs must be actual links to the sources cited in your report.
- Example format with REAL URLs:
  [1] Electric vehicles reach tipping point in China: https://electrek.co/2025/08/29/electric-vehicles-reach-tipping-point-china-surge-51-market-share/
  [2] China's EV Market Analysis: https://www.iea.org/reports/global-ev-outlook-2025
